...
class Day8:
    ...
    def find_layer_with_smallest_instances_of_n(processed_image_layers: Dict[int, List[List[int]]], n: int) -> int:
        ...
        for layer_num, layer in processed_image_layers.items():
            layer_count: int = Day8.get_count_of_n_in_layer(layer, n)
    ...
    def run():
        ...
        layered_image: Dict[int, List[List[int]]] = Day8.split_into_layers(image_stream, 25, 6)
        # start part 1
        layer_num: int = Day8.find_layer_with_smallest_instances_of_n(layered_image, 0)
        print(f'{Day8.get_count_of_n_in_layer(layered_image[layer_num], 1) * Day8.get_count_of_n_in_layer(layered_image[layer_num], 2)}')
        # end part 1
        print()
        # start part 2
        # Day8.helper_show_layers(layered_image)
        Day8.decode_image(layered_image)
        # end part 2
